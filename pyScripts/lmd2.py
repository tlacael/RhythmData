...
DEFAULT_HDFILE = "/Users/Tlacael/NYU/RhythmData/lmd32x60.hdf5"
...
class RhythmDataset(Dataset):
    ...
    def get(self, ikey):
        ...
        if len(self.scalars):
            x = (x - self.scalars[0].reshape(1,60,32))/self.scalars[1].reshape(1,60,32)
        return x, y
...
origDimX = 60;
origDimY = 60;
arch_lmd = [AffineArgs(weight_shape=(64*25,800)),
